...
export class News extends Component {
    ...
    async componentDidMount() {
      console.log("CDM")
      let url = `https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=db927250299d449c83d67e1683b1adcc&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
